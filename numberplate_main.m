...
im = imread('E:\Projects\Car number plate dectection\kode4u car number plate dectection\img\car8.jpg');
...
t=datetime;
dst=datestr(t);
fileID=fopen('Plate Details2.txt','a');
fprintf(fileID,'%s',noPlate);
fprintf(fileID,'\t%s',dst);
fprintf(fileID,'\r\n');
fclose(fileID);